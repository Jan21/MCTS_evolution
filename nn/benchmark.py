...
# 128 graphs, held out by id so val/test boards are unseen.
SPLITS = {
    "train": list(range(0, 96)),
    "val":   list(range(96, 112)),
    "test":  list(range(112, 128)),
}
...
def summary(records, pred_scalar, num_classes):
    return {
        ...
        "acc": round(accuracy(records, pred_scalar, num_classes), 3),
