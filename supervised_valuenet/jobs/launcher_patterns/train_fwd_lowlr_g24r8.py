"""g24r8 forward control retrain, lr 1e-4, with the config's split rebinding."""
import inspect
import sys
import torch
...
print("[ctl24] SPLITS rebound", flush=True)
...
print("[ctl24] lr default forced to 1e-4", flush=True)

sys.argv = ["net", "--data", "scaling/data/g24r8/forward.jsonl",
            "--epochs", "5", "--batch-size", "32", "--num-workers", "8"]
mn.main()
