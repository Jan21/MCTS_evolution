...
def sec_databudget(D):
    ...
    ledger = (
        ...
        "neither side ever received a learning-rate sweep, and the "
        "forward planner is single-seed at every configuration \u2014 "
        "only the subgoal planner's two single-draw headline rungs "
        "have been repeated under fresh seeds (fairness tab), so no "
